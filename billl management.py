...
#MENU CARD
f=Frame(root,bg="light green",highlightbackground="black",highlightthickness=1,width=310,height=370)
f.place(x=10,y=118)
...
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Cookies..........Rs.60/plate",fg="black",bg="lightgreen").place(x=10,y=110)
...
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Juice..........Rs.25/glass",fg="black",bg="lightgreen").place(x=10,y=200)
...
#BILL
f2=Frame(root,bg="lightyellow",highlightbackground="black",highlightthickness=3,width=300,height=370)
...
#ENTRY WORK
f1=Frame(root,bd=5,highlightbackground="black",highlightthickness=1,height=370,width=300)
f1.pack()
dosa=StringVar()
cookies=StringVar()
Tea=StringVar()
